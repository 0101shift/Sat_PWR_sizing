...
export function createCustomSatelliteDraft(): SatelliteInventoryItem {
  return {
    ...
    array: { wingLayout: "dual", panelsPerWing: 3, panelLengthM: 2.1, panelWidthM: 0.68, deploymentAxis: "+Y", deployedAngleDeg: 90, foldDirection: "lateral", cellModel: "AZUR 3G30-Advanced 4x8", seriesCells: 19, parallelStrings: 24, packagingEfficiency: 0.88, operatingTemperatureC: 60 },
    missionDefaults: { attitudeMode: "Mission profile / DIL" },
    powerDefaults: { energyConversionMode: "MPPT", nominalBusVoltageV: 28, mpptEfficiency: 0.95, fluenceE14Cm2: 5, referenceIrradianceWm2: 1367, referenceTemperatureC: 28, powerTempCoefficientPctC: -0.08, pointingErrorDeg: 0, angularResponseExponent: 1, harnessEfficiency: 1, mismatchLossPct: 0, diodeLossPct: 0, contaminationLossPct: 0, selfShadowLossPct: 0, systemLossPct: 12, batteryWh: 1000 },
    subsystems: [],
  };
}
